...
typedef struct MPContext {
    ...
    // Amcfy: 轻量实时音频能量桶，供 libmpv property 推给 Flutter 可视化层。
#define AMCFY_AUDIO_LEVEL_COUNT 96
    double amcfy_audio_levels[AMCFY_AUDIO_LEVEL_COUNT];
    int64_t amcfy_audio_levels_update_ns;
